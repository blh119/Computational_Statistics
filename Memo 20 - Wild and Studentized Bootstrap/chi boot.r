...
xax<-1:19/20
plot(xax,bsna8[,1], type="o", pch=0, bg=par("bg"), col = "blue",ylim=c(-0.035,0.06),ylab="Bias", cex=.6, main='Bias for CHI8')
...
#
xax<-1:19/20
plot(xax,bsna8[,2], type="o", pch=0, bg=par("bg"), col = "blue",ylim=c(0,0.008),ylab="MSE", cex=.6, main='MSE for CHI8')
...
legend(0.001, .008, legend=c("Normal","Plain","Wild","Stu"),
       col=c("blue", "darkgreen","darkorchid","darkorange"), 
       lty=1, cex=0.6,text.font=1,box.lty=0)
